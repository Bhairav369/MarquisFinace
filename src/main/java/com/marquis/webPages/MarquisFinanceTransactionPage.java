...
public class MarquisFinanceTransactionPage {
	...
	//Green finance house button
		...
		public static By marquisRef = By.xpath("(//*[@id='lblInformationApplyTop']/text())[2]");
	...
	public static void addVehicleDetails() throws Exception
	{
		...
		String vUse = xcl.getCellValue(xlpath,"Sheet1",37,12);
		Utilities.verifyElementPresentAndClick(MarquisFinanceTransactionPage.vehicleUse(vUse),"Select Vehicle use ");
		
		String vehicleType = xcl.getCellValue(xlpath,"Sheet1",35,12);
		Utilities.verifyElementPresentAndClick(MarquisFinanceTransactionPage.vehicleCondition(vehicleType), "is  Vehicle New ?");
		logger.info("Is Vehicle New ");
		ExtentReporter.extentLoggerPass("Is Vehicle New ", "Option selected ");

		if(vehicleType == "USED") {
			String odoMeter = xcl.getCellValue(xlpath,"Sheet1",36,12);
		...
		String vehicleCode = xcl.getCellValue(xlpath,"Sheet1",31,12);
		...
		Utilities.verifyElementPresentAndClick(MarquisFinanceTransactionPage.vehicleSearchButton,"Search Vehcile Code");
		Utilities.verifyElementPresentAndClick(MarquisFinanceTransactionPage.selectSearchResult,"Select Searched Result ");
		
	
		Utilities.switchFrame_parent();

		Utilities.clearField(MarquisFinanceTransactionPage.vehRegNumber, " vehRegNumber field");
		String readRegNumber = xcl.getCellValue(xlpath,"Sheet1",30,12);
		...
		String readChasis = xcl.getCellValue(xlpath,"Sheet1",28,12);
		...
		String readEngineNumber = xcl.getCellValue(xlpath,"Sheet1",29,12);
	...
	public static void addInterestDetails() throws Exception
	{
		...
		String sellingPrice = xcl.getCellValue(xlpath,"Sheet1",32,12);
		...
		String firstRegDate = xcl.getCellValue(xlpath,"Sheet1",33,12);
		Utilities.type(MarquisFinanceTransactionPage.firstRegDateVehicle, firstRegDate, " First Reg Date ");
		
		
		
		//38
		String agreementType = xcl.getCellValue(xlpath,"Sheet1",38,12);
		...
		String interestRate = xcl.getCellValue(xlpath,"Sheet1",34,12);
		...
		Utilities.verifyElementPresentAndClick(MarquisFinanceTransactionPage.paymentFrequency_monthly, " Payment Frequency ");
	}
