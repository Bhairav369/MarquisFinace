...
public class ClientDetailsPage {
	...
	//ExcelFunctions xcl = new ExcelFunctions();
		...
		//Title radio buttons
		public static By titleRadioButton = By.xpath("//*[@value=\"MR\"]");
		
		//ID Type radio buttons
		public static By idTypeRadioButton = By.xpath("//*[@value=\"PASSPORT\"]");
		...
		//selected salary day
		public static By selectedSalaryDay = By.xpath("//*[@id=\"ddlEmpSalaryDay\"]//*[text()=\"25\"]");
		...
		public static void addClientDetails() throws Exception {
			...
			Utilities.explicitWaitVisible(MarquisFinanceTransactionPage.clientDetailsAddButton,10);
			Utilities.JSClick(MarquisFinanceTransactionPage.clientDetailsAddButton,"Add client details button clicked");
			...
			Assert.assertEquals(addClientHeaderText,"Add Client");
			...
			Utilities.verifyElementPresentAndClick(ClientDetailsPage.titleRadioButton,"Title radio button");
			...
			Utilities.verifyElementPresentAndClick(ClientDetailsPage.idTypeRadioButton,"ID Type radio button");
			logger.info("ID Type");
			...
			Utilities.type(ClientDetailsPage.idNumber,"9208060255080", "Typed "+readIdNumber+" in add client id number field");
			String idNumberValue = Utilities.getAttributValue("value",ClientDetailsPage.idNumber);
			Assert.assertEquals(idNumberValue, "9208060255080");
...
//			Assert.assertEquals(selecedCitizenshipText, readCitizenship);
			...
			Utilities.type(ClientDetailsPage.mobileNumber,"0988632776","Typed"+ readMobileNumber + " in mobile number text field");
			String mobileNumber = Utilities.getAttributValue("value",ClientDetailsPage.mobileNumber);
			Assert.assertEquals(mobileNumber, "0988632776");
			...
			Utilities.type(ClientDetailsPage.telephoneCode,"0"+readTelecode.substring(0,2),"Typed"+ readTelecode +" in telephone code text field");
			String telephoneCode = Utilities.getAttributValue("value",ClientDetailsPage.telephoneCode);
			Assert.assertEquals(telephoneCode, "0"+readTelecode.substring(0,2));
			...
			Assert.assertEquals(telephoneNumber, "2572080");
			...
			String salaryDayTxt = Utilities.getText(ClientDetailsPage.selectedSalaryDay);
