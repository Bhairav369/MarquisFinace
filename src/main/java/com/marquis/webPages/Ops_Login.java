...
public SoftAssert softAssert = new SoftAssert();
	...
	public static By ImNtRbtFld=By.xpath("//div[@class='col-12 d-flex justify-content-center mx-0 ng-star-inserted']");
	...
	public static By UserNameReqIcon=By.xpath("(//i[@class='bg-white pointer pi pi-info-circle text-danger ng-star-inserted'])[1]");
	...
	public static By PswrdDecryption=By.xpath("//i[@class='bg-white pointer pi pi-eye text-secondary ng-star-inserted']");
	
	//Password text is in Encryption mode
	public static By PswrdTextEncryption=By.xpath("/html/body/app-root/app-login/div/div/div/div[2]/form/div/div[1]/field-display[2]/span/div/div/label/span/i" );
	
	//I Am Not A Robot
	public static By IamNtRobot=By.xpath("//div[@class='col-12 d-flex justify-content-center mx-0 ng-star-inserted']");
	...
	//Send OTP Title
	public static By SendOtpTitle=By.xpath("//body/app-root/app-login[@class='ng-star-inserted']/div[@class='back-ground']/div[@class='container']/div[@class='row d-flex justify-content-center']/div[@class='col form-login py-5 m-0 shadow-lg bg-body']/form[@class='ng-invalid ng-dirty ng-touched']/div[@class='row ng-star-inserted']/div[@class='col-12']/label[1]");
	...
	//Back Button
	public static By BackBtn=By.xpath("(//i[@class='pi pi-chevron-circle-left pt-2'])[1]");
	...
	public static By EntrOtpTxtPlc=By.xpath("//label[@for='Enter OTP']//span[@class='bg-white']");
	
	//Resend OTP Via Mobile no 
	public static By ResendOtpViMob=By.xpath("(//button[@type='button'])[1]");
	
	//Resend OTP Via Email
	public static By ResendOtpViEmail=By.xpath("(//button[@ng-reflect-text='Resent OTP Via Email on bh****'])[1]");
	...
	Utilities.verifyIsElementDisplayed(Ops_Login.PswrdTextEncryption, "password text is turns to the Encryption mode");
	Utilities.screencapture();
	...
	Utilities.waitTime(3000);
	Utilities.verifyIsElementDisplayed(Ops_Login.SendOtpTitle, "Send OTP Title");
	...
	/*
	 * Utilities.verifyIsElementDisplayed(Ops_Login.BackBtn, "BAck Button");
	 * Utilities.click(Ops_Login.BackBtn, "BAck Button");
	 * 
	 * Utilities.click(Ops_Login.IamNtRobot, "I am Not a Robot Checkbox");
	 * 
	 * Utilities.waitTime(3000); Utilities.click(Ops_Login.SubmitBtn,
	 * "Submit Button");
	 * 
	 * Utilities.click(Ops_Login.EmlRadioBtn, "Email Radio Button");
	 */
	...
	Utilities.verifyIsElementDisplayed(Ops_Login.SendOtpTitle, "Send OTP To Title");
